...
<div id="container4">
  ...
  <label class="form-label" for="">Họ và tên</label>
    <input value="<?php echo $_SESSION['user']['hoVaTen'];?>" type="text" id="" class="form-control" required name="hoVaTen" />
  </div>

  <div class="form-outline mb-4">
    <label class="form-label" for="">Tên tài khoản</label>
    <input value="<?php echo $_SESSION['user']['tenTaiKhoan'];?>" type="text" id="" class="form-control" required name="tenTaiKhoan" />
  </div>

  <div class="form-outline mb-4">
    <label class="form-label" for="">Email</label>
    <input value="<?php echo $_SESSION['user']['email'];?>" type="email" id="" class="form-control" required name="email" />
  </div>

  <div class="form-outline mb-4">
    <label class="form-label" for="">Số điện thoại</label>
    <input value="<?php echo $_SESSION['user']['soDienThoai'];?>" type="text" id="" class="form-control" required name="soDienThoai" />
  </div>
  ...
  <div class="form-outline mb-4">
    ...
    <input value="<?php echo $_SESSION['user']['namSinh'];?>" type="date" id="" class="form-control" required name="namSinh" />
  </div>
  <div class="form-outline mb-4">
    <label class="form-label" for="">Link FaceBook</label>
    <input value="<?php echo $_SESSION['user']['linkFaceBook'];?>" type="text" id="" class="form-control" required name="linkFaceBook" />
  </div>
  <div class="form-outline mb-4">
  ...
  <div class="form-outline mb-4">
    ...
    <input value="<?php echo $_SESSION['user']['truongHoc'];?>" type="text" id="" class="form-control" required name="truongHoc" />
  </div>
